...
public class RecepViewController extends Application {
    ...
    void SearchPatient(ActionEvent event) {
    	Node node = (Node) event.getSource();
    	Stage primaryStage = (Stage) node.getScene().getWindow();
    	SearchPatientController.searchPatientRecep(primaryStage);
	...
	public void start(Stage primaryStage) throws Exception {
		...
		try{
			BorderPane root = (BorderPane) FXMLLoader.load(getClass().getResource("/view/ReceptionistView.fxml"));
